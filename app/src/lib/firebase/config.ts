...
export const auth = (app && !skipAuth) ? getAuth(app) : null;

// QA Hardening: Force Long Polling to avoid ERR_QUIC_PROTOCOL_ERROR
export const db = (app && process.env.SKIP_AUTH !== '1') ? initializeFirestore(app, {
  experimentalForceLongPolling: true,
}) : null;

export const storage = (app && process.env.SKIP_AUTH !== '1') ? getStorage(app) : null;
