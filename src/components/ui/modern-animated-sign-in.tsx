    ...
    <section className='max-md:w-full flex flex-col gap-4 w-96 mx-auto'>
      ...
      {googleLogin && (
        <>
          ...
          >
            <button
              className='g-button group/btn bg-transparent w-full rounded-md border h-10 font-medium outline-none hover:cursor-pointer transition-colors border-[var(--btn-border)]'
              type='button'
