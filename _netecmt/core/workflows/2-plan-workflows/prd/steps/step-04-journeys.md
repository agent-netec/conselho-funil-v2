...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with the current journey content
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with the current journeys
...
- Load `{project-root}/_netecmt/core/workflows/2-plan-workflows/prd/steps/step-05-domain.md` (or determine if step is optional based on domain complexity)
