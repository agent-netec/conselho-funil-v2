...
# Path Definitions
workflow_path: '{project-root}/_netecmt/core/workflows/2-plan-workflows/prd'
...
# Task References
advancedElicitationTask: '{project-root}/_netecmt/core/tasks/advanced-elicitation.xml'
partyModeWorkflow: '{project-root}/_netecmt/core/workflows/party-mode/workflow.md'
---
...
- When 'A' selected: Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml
- When 'P' selected: Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md
...
- Load `{project-root}/_netecmt/core/workflows/2-plan-workflows/prd/project-types.csv` completely
...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with the current innovation content
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with the current innovation content
...
- Load `{project-root}/_netecmt/core/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`
...
If user selects 'A', proceed with content generation anyway. If 'C', skip this step and load `{project-root}/_netecmt/core/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`.
...
Skip this step and load `{project-root}/_netecmt/core/workflows/2-plan-workflows/prd/steps/step-07-project-type.md` if:
...
After user selects 'C' and content is saved to document (or step is skipped), load `{project-root}/_netecmt/core/workflows/2-plan-workflows/prd/steps/step-07-project-type.md`.
