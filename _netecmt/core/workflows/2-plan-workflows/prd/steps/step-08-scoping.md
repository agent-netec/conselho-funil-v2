...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with current scoping analysis
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with scoping context
