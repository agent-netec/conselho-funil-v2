...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with the current design system content
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with the current design system choice
