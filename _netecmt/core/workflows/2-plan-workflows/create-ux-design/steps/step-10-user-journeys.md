...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with the current user journey content
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with the current user journeys
