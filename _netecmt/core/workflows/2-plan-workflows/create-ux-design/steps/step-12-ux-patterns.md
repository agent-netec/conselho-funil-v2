...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with the current UX patterns content
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with the current UX patterns
