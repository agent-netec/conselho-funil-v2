...
Load, read the full file and then execute `{project-root}/_netecmt/core/workflows/1-analysis/create-product-brief/steps/step-01-init.md` to begin the workflow.
