...
<critical>You MUST have already loaded and processed: {project-root}/_netecmt/core/workflows/document-project/workflow.yaml</critical>
...
<invoke-workflow path="{project-root}/_netecmt/core/workflows/workflow-status">
