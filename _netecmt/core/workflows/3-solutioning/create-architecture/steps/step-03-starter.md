...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with current starter analysis
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with starter evaluation context
