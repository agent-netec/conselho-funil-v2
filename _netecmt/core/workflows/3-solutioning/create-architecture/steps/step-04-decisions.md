...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with specific decision categories
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with architectural decisions context
