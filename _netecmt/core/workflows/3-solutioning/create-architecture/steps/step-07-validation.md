...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with validation issues
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with validation context
