...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with current patterns
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with implementation patterns context
