...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with the current context analysis
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with the current project context
