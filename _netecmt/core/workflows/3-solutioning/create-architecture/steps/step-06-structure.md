...
- Execute {project-root}/_netecmt/core/tasks/advanced-elicitation.xml with current project structure
...
- Execute {project-root}/_netecmt/core/workflows/party-mode/workflow.md with project structure context
