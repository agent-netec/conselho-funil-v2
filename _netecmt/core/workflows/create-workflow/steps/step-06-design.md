...
- `{project-root}/_netecmt/core/docs/workflows/templates/step-template.md` - Step file structure
- `{project-root}/_netecmt/core/docs/workflows/templates/step-01-init-continuable-template.md` - Continuable init step template
- `{project-root}/_netecmt/core/docs/workflows/templates/step-1b-template.md` - Continuation step template
- `{project-root}/_netecmt/core/docs/workflows/templates/workflow-template.md` - Workflow configuration
- `{project-root}/_netecmt/core/reference/workflows/meal-prep-nutrition/workflow.md` - Complete example
...
```
Read: {project-root}/_netecmt/core/docs/workflows/templates/step-template.md
```

This shows the standard structure for step files. Also reference:

```
Read: {project-root}/_netecmt/core/docs/workflows/templates/step-1b-template.md
```
