...
# Path Definitions
workflow_path: '{project-root}/_netecmt/core/workflows/create-workflow'
...
# Template References
workflowTemplate: '{project-root}/_netecmt/core/docs/workflows/templates/workflow-template.md'
stepTemplate: '{project-root}/_netecmt/core/docs/workflows/templates/step-template.md'
stepInitContinuableTemplate: '{project-root}/_netecmt/core/docs/workflows/templates/step-01-init-continuable-template.md'
step1bTemplate: '{project-root}/_netecmt/core/docs/workflows/templates/step-1b-template.md'
...
- When building each step file, you must follow template `{project-root}/_netecmt/core/docs/workflows/templates/step-template.md`
- When building continuable step-01-init.md files, use template `{project-root}/_netecmt/core/docs/workflows/templates/step-01-init-continuable-template.md`
- When building continuation steps, use template `{project-root}/_netecmt/core/docs/workflows/templates/step-1b-template.md`
- When building the main workflow.md file, you must follow template `{project-root}/_netecmt/core/docs/workflows/templates/workflow-template.md`
- Example step files from {project-root}/_netecmt/core/reference/workflows/meal-prep-nutrition/workflow.md for patterns
...
For bmb module, this will be: `_netecmt/custom/src/workflows/{workflow_name}/`
...
- Configure all path variables ({project-root}, _netecmt, {workflow_path})
