...
commonToolsCsv: '{project-root}/_netecmt/core/docs/workflows/common-workflow-tools.csv'
...
- ✅ You bring expertise in NETECMT tools and integration patterns
...
Based on your workflow requirements, let's configure all the tools your workflow will need. This includes core NETECMT tools, memory systems, and any external integrations."

### 2. Load and Present Available Tools

Load `{commonToolsCsv}` and present tools by category:

"**Available NETECMT Tools and Integrations:**
...
### 3. Configure Core NETECMT Tools

"**Core NETECMT Tools Configuration:**
