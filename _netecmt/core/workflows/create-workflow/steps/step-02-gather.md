...
```
Read: {project-root}/_netecmt/core/reference/workflows/meal-prep-nutrition/workflow.md
```
...
- **Linear**: Like Meal Prep Plan (Init → Profile → Assessment → Strategy → Shopping → Prep)
  - See: `{project-root}/_netecmt/core/reference/workflows/meal-prep-nutrition/`
