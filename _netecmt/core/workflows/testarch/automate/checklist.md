...
**Note:** NETECMT artifacts (story, tech-spec, PRD) are OPTIONAL - workflow can run without them
...
- [ ] **Note**: Absence of NETECMT artifacts does NOT halt workflow
...
**NETECMT-Integrated Mode (if story available):**
...
- [ ] Document includes execution mode (NETECMT-Integrated, Standalone, Auto-discover)
...
### With NETECMT Workflows (If Available - OPTIONAL)
...
### Issue: NETECMT artifacts not found

**Problem:** Story, tech-spec, or PRD files not found when variables are set.

**Resolution:**

- **automate does NOT require NETECMT artifacts** - they are OPTIONAL enhancements
- If files not found, switch to Standalone Mode automatically
- Analyze source code directly without NETECMT context
...
- Message: "Framework scaffolding required. Run `NETECMT tea *framework` first."
...
- **automate is flexible:** Can work with or without NETECMT artifacts (story, tech-spec, PRD are OPTIONAL)
