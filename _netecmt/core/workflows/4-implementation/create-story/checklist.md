...
- The `{project_root}/_netecmt/core/tasks/validate-workflow.xml` framework will automatically:
...
3. **Load validation framework**: `{project_root}/_netecmt/core/tasks/validate-workflow.xml`
