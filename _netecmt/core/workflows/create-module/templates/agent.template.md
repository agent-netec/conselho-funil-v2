...
agent:
  ...
  critical_actions:
    - 'Load COMPLETE file [project-root]/_netecmt/_memory/[agent-name]-sidecar/memories.md and integrate all past interactions'
    - 'Load COMPLETE file [project-root]/_netecmt/_memory/[agent-name]-sidecar/instructions.md and follow ALL protocols'
  ...
  menu:
    ...
    - trigger: 'generate-report'
      route: '{project-root}/_netecmt/{custom_module}/workflows/report-gen/workflow.md'
    ...
    - multi: "[PD] Pitch Deck [EX] Explainer Video"
      triggers:
        - pitch-deck:
          ...
          route: "{project-root}/_netecmt/{custom_module}/workflows/pitch-deck/workflow.md"
          description: 'Investor pitch deck 📈'
        - explainer:
          input: EX or fuzzy match explainer
          route: "{project-root}/_netecmt/{custom_module}/workflows/explainer/workflow.md"
