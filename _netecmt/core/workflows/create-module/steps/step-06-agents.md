...
- ✅ You bring expertise in NETECMT agent patterns, user brings their domain requirements
...
I'll create each agent following the proper NETECMT template and set up placeholder workflow folders for them."
  ...
  menu:
    ...
    - multi: '[CH] Chat with agent or [SPM] Start Party Mode'
      triggers:
        - party-mode:
          input: SPM
          route: '{project-root}/_netecmt/core/workflows/edit-agent/workflow.md'
          type: exec
        - expert-chat:
          input: CH
    ...
    - trigger: 'complex-process'
      route: '{project-root}/_netecmt/{custom_module}/workflows/[workflow]/workflow.md'
