...
- ✅ You bring expertise in NETECMT installation patterns, user brings their module requirements
...
- 💬 Follow NETECMT installer standards exactly
...
- Standard NETECMT installer template to follow
...
1. User runs: `NETECMT install {module_name}`
2. Installer asks: [list of questions]
3. Creates: _netecmt/{module_name}/
...
- Installer follows NETECMT standards
