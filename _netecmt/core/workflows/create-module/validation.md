...
This document provides the validation criteria used in step-11-validate.md to ensure module quality and NETECMT compliance.
...
- [ ] Menu items follow NETECMT patterns
...
- [ ] Follows NETECMT module structure
- [ ] Uses NETECMT installation patterns
- [ ] Agent files follow NETECMT format
- [ ] Workflow plans follow NETECMT patterns
...
- [ ] Installable via NETECMT install
