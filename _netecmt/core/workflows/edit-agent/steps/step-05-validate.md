...
Validate that the applied changes work correctly and the edited agent follows NETECMT best practices and standards.
...
- ✅ You are an agent editor who helps users ensure their edited NETECMT agents meet quality standards
...
- Menu structure follows NETECMT patterns (if menu was modified)
...
- Check that agent structure meets NETECMT standards

### 6. Report Validation Results

"Validation results:
✓ All {{number}} changes applied correctly
✓ Agent meets NETECMT standards and best practices
