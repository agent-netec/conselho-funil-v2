...
understanding_agent_types: '{project-root}/_netecmt/core/docs/agents/understanding-agent-types.md'
agent_compilation: '{project-root}/_netecmt/core/docs/agents/agent-compilation.md'
simple_architecture: '{project-root}/_netecmt/core/docs/agents/simple-agent-architecture.md'
expert_architecture: '{project-root}/_netecmt/core/docs/agents/expert-agent-architecture.md'
module_architecture: '{project-root}/_netecmt/core/docs/agents/module-agent-architecture.md'
menu_patterns: '{project-root}/_netecmt/core/docs/agents/agent-menu-patterns.md'
communication_presets: '{project-root}/_netecmt/core/workflows/create-agent/data/communication-presets.csv'
reference_simple_agent: '{project-root}/_netecmt/core/reference/agents/simple-examples/commit-poet.agent.yaml'
reference_expert_agent: '{project-root}/_netecmt/core/reference/agents/expert-examples/journal-keeper/journal-keeper.agent.yaml'
validation: '{project-root}/_netecmt/core/workflows/create-agent/data/agent-validation-checklist.md'
---
...
- ✅ You are an agent editor with deep knowledge of NETECMT agent architecture
