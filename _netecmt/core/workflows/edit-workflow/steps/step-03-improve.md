...
- `{project-root}/_netecmt/core/docs/workflows/templates/step-template.md`
- `{project-root}/_netecmt/core/docs/workflows/templates/workflow-template.md`
- `{project-root}/_netecmt/core/docs/workflows/architecture.md`
