...
agentMenuPatterns: '{project-root}/_netecmt/core/docs/agents/agent-menu-patterns.md'
simpleArchitecture: '{project-root}/_netecmt/core/docs/agents/simple-agent-architecture.md'
expertArchitecture: '{project-root}/_netecmt/core/docs/agents/expert-agent-architecture.md'
moduleArchitecture: '{project-root}/_netecmt/core/docs/agents/module-agent-architecture.md'
...
- Menu patterns compliant with NETECMT standards
