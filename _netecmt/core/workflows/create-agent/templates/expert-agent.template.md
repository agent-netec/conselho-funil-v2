...
cp -r /path/to/journal-keeper/ _netecmt/custom/agents/

# Install with personalization
NETECMT agent-install
```
...
3. **Use _netecmt/_memory/[agentname]-sidcar/ paths** - For reference to any sidecar content
...
- [ ] Menu actions reference _netecmt/_memory/[agentname]-sidcar/ correctly if needing sidecar content reference
- [ ] File paths use _netecmt/_memory/[agentname]-sidcar/ to reference where the file will be after sidecar content is installed
