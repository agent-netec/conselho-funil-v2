...
- Agent compilation guide: `{project-root}/_netecmt/core/docs/agents/agent-compilation.md`
- Agent types guide: `{project-root}/_netecmt/core/docs/agents/understanding-agent-types.md`
- Architecture docs: simple, expert, module agent architectures
- Menu patterns guide: `{project-root}/_netecmt/core/docs/agents/agent-menu-patterns.md`
