...
This folder contains a complete reference implementation of a **NETECMT Expert Agent** - an agent with persistent memory and domain-specific resources via a sidecar folder.
