...
This folder contains a complete reference implementation of a **NETECMT Simple Agent** - a self-contained agent with all logic embedded within a single YAML file.
...
agent:
  metadata:
    id: _netecmt/agents/{agent-name}/{agent-name}.md  # Build path
    name: "Display Name"
...
_This reference demonstrates how NETECMT Simple Agents can be surprisingly powerful while maintaining architectural simplicity._
