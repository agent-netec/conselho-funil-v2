...
# Path Definitions
workflow_path: '{project-root}/_netecmt/core/reference/workflows/meal-prep-nutrition'
...
- IF A: Execute `{project-root}/_netecmt/core/tasks/advanced-elicitation.xml`
- IF P: Execute `{project-root}/_netecmt/core/workflows/party-mode/workflow.md`
