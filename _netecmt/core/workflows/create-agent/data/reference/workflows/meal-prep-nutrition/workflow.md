...
Load, read the full file and then execute `{project-root}/_netecmt/core/reference/workflows/meal-prep-nutrition/steps/step-01-init.md` to begin the workflow.
