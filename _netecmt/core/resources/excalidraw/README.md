...
helpers: '{project-root}/_netecmt/core/resources/excalidraw/excalidraw-helpers.md'
json_validation: '{project-root}/_netecmt/core/resources/excalidraw/validate-json-instructions.md'
```
