...
/* ─── TARGET ICON (custom for Hero) ─── */
export function TargetIcon({ size = 40, color = "currentColor", className }) {
  return (
    <motion.svg
      viewBox="0 0 40 40"
      fill="none"
    ...
    >
      ...
      <circle cx="20" cy="20" r="10" stroke={color} strokeWidth={2} opacity={0.5} />
      <circle cx="20" cy="20" r="4" fill={color} />
      <line x1="20" y1="2" x2="20" y2="8" stroke={color} strokeWidth={2} strokeLinecap="round" />
      <line x1="20" y1="32" x2="20" y2="38" stroke={color} strokeWidth={2} strokeLinecap="round" />
      <line x1="2" y1="20" x2="8" y2="20" stroke={color} strokeWidth={2} strokeLinecap="round" />
      <line x1="32" y1="20" x2="38" y2="20" stroke={color} strokeWidth={2} strokeLinecap="round" />
    </motion.svg>
  );
}

/* ─── CROWN ICON (custom animated) ─── */
export function CrownIcon({ size = 40, color = "currentColor", className }) {
  return (
    <motion.svg
      viewBox="0 0 40 40"
      fill="none"
    ...
    >
      <path
        d="M6 28L10 12L20 18L30 12L34 28H6Z"
        stroke={color}
        strokeWidth={2}
...
/* ─── ZAP/BOLT ICON (custom animated) ─── */
export function BoltIcon({ size = 40, color = "currentColor", className }) {
  return (
    <motion.svg
      viewBox="0 0 40 40"
      fill="none"
    ...
    >
      <motion.path
        d="M22 4L8 22H18L16 36L32 18H22L22 4Z"
        fill={color}
